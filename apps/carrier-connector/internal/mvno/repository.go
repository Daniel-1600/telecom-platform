...
// Repository defines the interface for MVNO data operations
type Repository interface {
	CreateMVNO(ctx context.Context, mvno *MVNO) error
	GetMVNO(ctx context.Context, id string) (*MVNO, error)
	GetMVNOByBusinessID(ctx context.Context, businessID string) (*MVNO, error)
	UpdateMVNO(ctx context.Context, mvno *MVNO) error
	ListMVNOs(ctx context.Context, filter *MVNOFilter) ([]*MVNO, error)
	DeleteMVNO(ctx context.Context, id string) error
	UpdateMVNOStatus(ctx context.Context, id string, status MVNOStatus) error
	GetMVNOStats(ctx context.Context) (map[string]interface{}, error)
}
...
func (r *GormRepository) CreateMVNO(ctx context.Context, mvno *MVNO) error {
...
func (r *GormRepository) GetMVNO(ctx context.Context, id string) (*MVNO, error) {
	var mvno MVNO
...
func (r *GormRepository) GetMVNOByBusinessID(ctx context.Context, businessID string) (*MVNO, error) {
	var mvno MVNO
...
func (r *GormRepository) UpdateMVNO(ctx context.Context, mvno *MVNO) error {
...
func (r *GormRepository) ListMVNOs(ctx context.Context, filter *MVNOFilter) ([]*MVNO, error) {
	query := r.db.WithContext(ctx).Model(&MVNO{})
...
func (r *GormRepository) DeleteMVNO(ctx context.Context, id string) error {
	if err := r.db.WithContext(ctx).Where("id = ?", id).Delete(&MVNO{}).Error; err != nil {
...
func (r *GormRepository) GetMVNOStats(ctx context.Context) (map[string]any, error) {
	...
	if err := r.db.WithContext(ctx).Model(&MVNO{}).Count(&totalCount).Error; err != nil {
	...
	var statusCounts []struct {
		Status MVNOStatus `gorm:"column:status"`
		Count  int64      `gorm:"column:count"`
	}
	if err := r.db.WithContext(ctx).Model(&MVNO{}).
	...
	var planCounts []struct {
		Plan  MVNOPlan `gorm:"column:plan"`
		Count int64    `gorm:"column:count"`
	}
	if err := r.db.WithContext(ctx).Model(&MVNO{}).
...
func (r *GormRepository) UpdateMVNOStatus(ctx context.Context, id string, status MVNOStatus) error {
	if err := r.db.WithContext(ctx).Model(&MVNO{}).Where("id = ?", id).Update("status", status).Error; err != nil {
